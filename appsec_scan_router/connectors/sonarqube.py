...
CONNECTOR_DEFINITION = ConnectorDefinition(
    ...
    fields=(
        ConnectorField("endpoint", "Server URL", required=True),
        ConnectorField("token", "User token", required=True, secret=True),
    ),
    factory=SonarQubeConnector,
)